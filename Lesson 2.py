...
# 2.1 Array creation
print(np.array(range(10))) # convert a list to array
print(range(10))
r=range(10)
print(list[r])
...
A = np.array([[1,2], [3,4],[7,8],[9,10]]) # convert a list of lists to 2-D array.
print(A)

B=np.zeros( (3,4) )           #Create a 3x4 zero array
print(B)

C=np.ones(( (3,4) ),dtype=int)           #Create a 3x4 zero array
print(C)

D=np.zeros_like(A)            # Create an array of 0s with the same shape as A
print(D)



E=np.ones((2,3,4), dtype=np.int16)   # create a 2x3x4 array with 1s
print(E)

np.ones_like(A)             # Create an array of 1s with the same shape as A

D=np.empty((2,3))             # Create an 2x3 empty array
print(D)

np.empty_like(A)            # Create an empty array with the same shape as A

E=np.arange(10, 30, 5)        # create an array with evenly spaced values
print(E)
F=np.arange(0, 2, 0.3)               #.3 increment
print(F)

G=np.linspace(0, 2, 9)        # create an array which divides the interval evenly
print(G)
